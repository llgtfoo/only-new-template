...
<script>
// const { version } = require('element-plus/package.json') // element-ui version from node_modules
  ...
  setup() {
    ...
    watch(theme, (val, oldVal) => {
      ...
      if (!state.chalk) {
        ...
        const url = '../../../node_modules/element-plus/dist/index.css'
      ...
      store.dispatch('common/user/doSetTheme', val)
    })
    function changeColor(color) {
      store.dispatch('common/user/doSetTheme', color)
      message({
        message: '换肤成功',
        type: 'success',
      })
    ...
    return { ...toRefs(state), userTheme, theme, changeColor }
  },
})
</script>
